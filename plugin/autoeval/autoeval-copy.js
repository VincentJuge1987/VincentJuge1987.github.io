		...
		for( var i = 0, len = areas.length; i < len; i++ ) {
			var element = areas[i];
                        ...
                        if (element.hasAttribute( 'data-autoeval' )) {
                          var name = element.attributes["data-autoeval"].value;
                        ...
                        if (element.hasAttribute( 'data-autojsstyle' )) {
                          var name = element.attributes["data-autojsstyle"].value;
                          var e = document.getElementById(name);
                          if (e == undefined) {
                        ...
                        if (element.hasAttribute( 'data-autostyle' )) {
                          var frame = frames[element.attributes["data-autostyle"].value];
                          if (frame == undefined) {
                            console.log("unknown frame " + element.attributes["data-autostyle"].value);
                          }
                        ...
                        if (element.hasAttribute( 'data-autojslog' )) {
                          var name = element.attributes["data-autojslog"].value;
                          var e = document.getElementById(name);
                          if (e == undefined) {
                        ...
                        if (element.hasAttribute( 'data-autojscanvas' )) {
                          var canvasId = element.attributes["data-autojscanvas"].value;
                          var canvas = document.getElementById(canvasId);
                          if (canvas == undefined) {
                            console.log("autojscanvas " + canvasId + " not found");
                            continue;
                          }
                          var once = element.hasAttribute('data-once'); 
                        ...
                        if (element.hasAttribute( 'data-autojs' )) {
                          var name = element.attributes["data-autojs"].value;
                          var e = document.getElementById(name);
                          //console.log("found " + e);
